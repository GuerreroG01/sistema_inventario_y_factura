...
export default function ExpiringProductsMetrics() {
    ...
    const { data, loading, error, page, setPage } = useExpiringProductsMetrics();
    ...
    return (
        <div
            ref={containerRef}
            className="rounded-3xl border border-gray-200/80 bg-white p-8 shadow-sm relative overflow-hidden"
        >
                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                            Productos cuya fecha de vencimiento ocurre durante
