...
import {
    Search, Phone, ToggleLeft, DollarSign, X, SlidersHorizontal, ChevronDown, ChevronUp
} from "lucide-react";
...
export default function CustomerFilters({
    filters, updateFilter, applyFilters, open, setOpen
}: Props) {
                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            <select
                                ...
                                onChange={(e)=>updateFilter("hasDebt", e.target.value)}
                                className="w-full rounded-xl border border-gray-300 bg-white py-2.5 pl-10 pr-3 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100"
                            >
                                <option value="">
                                    Todos los clientes
